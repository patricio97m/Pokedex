<header class="bg-light p-3">
    <nav class="navbar navbar-light justify-content-between">
        ...
        <form class="form-inline my-2 my-lg-0 d-flex">
            ...
            <input class="form-control mx-2" type="password" placeholder="Contraseña" name="contraseña" />
            <button method="post" action="ingresar.php" class="btn btn-outline-success ml-2 my-2 my-sm-0" type="submit">
                Ingresar
            </button>
        </form>
    </nav>
